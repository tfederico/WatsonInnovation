...
def _images_get_all_items(page):
    ...
    while True:
        ...
        if item == "no_links":
            ...
            time.sleep(pause)        #Timer could be used to slow down the request for image downloads
...
if __name__ == '__main__':
    ...
    search_keyword = [paint]

    #This list is used to further add suffix to your search term. Each element of the list will help you download 100 images. 
    #First element is blank which denotes that no suffix is added to the search keyword of the above list. You can edit the list by adding/deleting
    #elements from it.So if the first element of the search_keyword is 'Australia' and the second element of keywords is 'high resolution', 
    #then it will search for 'Australia High Resolution'
    keywords = [' painting']+auth

    n_max = n_max * len(keywords)
    ...
    while i<len(search_keyword):
        ...
        #This allows you to write all the links into a test file. This text file will be created in the same directory as your code. 
